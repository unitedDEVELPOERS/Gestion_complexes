...
public class Client extends User{
   ...
   public Client(int idUser, int equipe){
       super(idUser);
       this.equipe=equipe;
   } 
...
public Client(int idUser, String email, String pwd, String role, String telephone,String nom, 
     ...
     public Client(int idUser, String email ,String pwd,String telephone,String nom,String prenom,String position){
         super(idUser,email,pwd,telephone);
         this.nom=nom;
      this.prenom=prenom;
      this.position=position;
...
//
//
//       public Client(int idUser,String email, String pwd,String telephone, String nom, String prenom,String equipe,int solde_points,
//               String position) {
//        super(idUser,email,pwd,telephone);
//      
//        this.equipe=equipe;
...
//       }
//    
//     public Client(int idUser, String email ,String pwd,String telephone,String nom,String prenom,String equipe,String position){
//         super(idUser,email,pwd,telephone);
//         this.nom=nom;
//      this.prenom=prenom;
//      this.position=position;
