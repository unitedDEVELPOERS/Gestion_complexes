...
import sevices.ServiceInvitation;
 ...
 * @author fachr
 */
public class VerificationboxController implements Initializable {
...
public int ide,idu;
    ...
    private void boui(ActionEvent event) {
        ServiceInvitation si= new ServiceInvitation();
                invitation i =new invitation(equipe.getId(),idu,"request");
        try {
            si.ajouter(i);
         ...
         try {
                     SendMail.mail("f.achref@live.fr",this.equipe.getNom(),1);
