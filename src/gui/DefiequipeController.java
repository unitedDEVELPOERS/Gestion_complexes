 ...
 * @author fachr
 */
public class DefiequipeController implements Initializable {
...
Image image= new Image("/icons/joueur.png");
    ...
    @FXML
    private void retourmenu(ActionEvent event) throws SQLException {
         try {
          ...
          pdc.setUtilisateur(utilisateur);
            cequipe.getScene().setRoot(root);}else{
    ...
    private void demandeequipe(ActionEvent event) throws SQLException, IOException {
      ...
      if(s.isEmpty()&&se.isEmpty()){
        ...
        FXMLLoader loader=new  FXMLLoader(getClass().getResource("creematch.fxml"));
            Parent root=loader.load();
          CreematchController pdc = loader.getController();
        selectequipe.setVisible(false);
    ...
    }else if(!se.isEmpty()){ try {   FXMLLoader loader=new  FXMLLoader(getClass().getResource("creematch.fxml"));
            Parent root=loader.load();
          CreematchController pdc = loader.getController();
        selectequipe.setVisible(false);
        ServiceEquipe ser =new ServiceEquipe();
