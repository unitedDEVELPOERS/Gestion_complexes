 ...
 * @author fachr
 */
public class ListematcheController implements Initializable {
 ...
 public utilisateur utilisateur; 
    ...
    public void setEquipe(equipe equipe) throws SQLException {
        ...
        for(int i=0;i<l.size();i++){
            if(equipe.getId()==l.get(i).getEquipe2()&&l.get(i).getValide()==1){
                listt.add(l.get(i));
            ...
            }if(equipe.getId()==l.get(i).getEquipe1()&&l.get(i).getValide()==1){
                listt.add(l.get(i));
                for(int j=0;j<le.size();j++){
                    if(le.get(j).getId()==l.get(i).getEquipe1()){
                        listte.add(le.get(j));
