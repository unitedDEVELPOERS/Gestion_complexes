...
//     ObservableList<participation> listE;
    ...
    @FXML
    private TableView<participeEQ> table_eq1_et_eq2;
   
    @FXML
    private TableColumn<participeEQ, ?> col_num_eq;
   
    @FXML
    private TableColumn<participeEQ, ?> col_eqp;
   
    @FXML
    private TableColumn<participeEQ, ?> col_nbj;
   ...
   @FXML
    ...
    public void UpdateTable2(){
        ...
        ObservableList listeq = FXCollections.observableArrayList();
        participantCRUD tc = new participantCRUD();
        listeq=(ObservableList) tc.Afficherparticipant();
        col_num_eq.setCellValueFactory(new PropertyValueFactory<>("id"));
        col_eqp.setCellValueFactory(new PropertyValueFactory<>("nom"));
        col_nbj.setCellValueFactory(new PropertyValueFactory<>("nbre_joueur"));
      

        listE = tc.Afficherparticipant();
        table_eq1_et_eq2.setItems(listE);
    ...
    private void afficher_les_eq(ActionEvent event) {
             ...
             participeEQ cccc = new participeEQ();
            participantCRUD tCrud = new participantCRUD();
            
             tCrud.Afficherparticipant();
             UpdateTable2();
